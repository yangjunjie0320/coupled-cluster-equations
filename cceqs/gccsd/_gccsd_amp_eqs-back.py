...
def gccsd_r1e(h1e, h2e, t1e, t2e):
    ...
    print('res0 - res = %6.4e' % numpy.linalg.norm(res0 - res))
    print('res1 - res = %6.4e' % numpy.linalg.norm(res1 - res))
    print('res2 - res = %6.4e' % numpy.linalg.norm(res2 - res))
    print('res3 - res = %6.4e' % numpy.linalg.norm(res3 - res))
